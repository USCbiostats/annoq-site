...
To facilitate straightforward integration, two libraries that encapsulate the AnnoQ API have also been developed:
1.  [R package (AnnoQR)](https://github.com/USCbiostats/AnnoQR)
2.  [python package (annoq-py)](https://github.com/USCbiostats/annoq-py)  


Utilizing the libraries allows for abstraction, realiability, performance optimization and portability. View the [R package]({{site.baseurl}}/docs/tutorials/r-package) and [python package]({{site.baseurl}}/docs/tutorials/annoq-py) tutorials for more details.